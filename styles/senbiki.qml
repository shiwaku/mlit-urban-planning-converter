...
<!-- 区域区分（senbiki）: 国土交通省 都市局『都市計画決定GISデータ』用のスタイル。
...
<qgis version="3.34.0" styleCategories="Symbology|Fields">
  <renderer-v2 type="categorizedSymbol" attr="AreaType" forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1">
    <categories>
      <category value="市街化区域" symbol="0" label="市街化区域" render="true"/>
      <category value="市街化調整区域" symbol="1" label="市街化調整区域" render="true"/>
      <category value="" symbol="2" label="その他" render="true"/>
    </categories>
    <symbols>
    <symbol name="0" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0">
      <layer class="SimpleFill" enabled="1" locked="0" pass="0">
        <Option type="Map">
          <Option name="color" type="QString" value="255,250,190,255"/>
          <Option name="outline_color" type="QString" value="255,160,230,255"/>
    ...
    <symbol name="1" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0">
      <layer class="SimpleFill" enabled="1" locked="0" pass="0">
        <Option type="Map">
          <Option name="color" type="QString" value="220,220,220,255"/>
          <Option name="outline_color" type="QString" value="255,160,230,255"/>
          <Option name="outline_style" type="QString" value="solid"/>
          <Option name="outline_width" type="QString" value="0.2"/>
          <Option name="outline_width_unit" type="QString" value="MM"/>
    ...
    <symbol name="2" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0">
      <layer class="SimpleFill" enabled="1" locked="0" pass="0">
        <Option type="Map">
          <Option name="color" type="QString" value="210,210,210,255"/>
