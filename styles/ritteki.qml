...
<!-- 立地適正化計画区域（ritteki）: 国土交通省 都市局『都市計画決定GISデータ』用のスタイル。
...
<qgis version="3.34.0" styleCategories="Symbology|Fields">
  <renderer-v2 type="categorizedSymbol" attr="AreaType" forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1">
    <categories>
      <category value="立地適正化計画区域" symbol="0" label="立地適正化計画区域" render="true"/>
      <category value="居住誘導区域" symbol="1" label="居住誘導区域" render="true"/>
      <category value="都市機能誘導区域" symbol="2" label="都市機能誘導区域" render="true"/>
      <category value="" symbol="3" label="その他" render="true"/>
    </categories>
    <symbols>
    <symbol name="0" type="fill" alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0">
      <layer class="SimpleFill" enabled="1" locked="0" pass="0">
        <Option type="Map">
          <Option name="color" type="QString" value="215,250,165,255"/>
          <Option name="outline_color" type="QString" value="160,195,95,255"/>
